...
\section{A brief history of glacier flow}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics<1>[width=8cm]{hugi-block-boulder-movement-1}
    \includegraphics<2>[width=8cm]{hugi-block-boulder-movement-2}
    \includegraphics<3>[width=8cm]{hugi-block-boulder-movement-3}
  \end{figure}
  \end{frame}

\begin{frame}
  \frametitle{The ``Hugi'' block}
      Between 1827--1836, J.~Hugi observed that a boulder moved $1315\,\text{m}$ downstream between 1827 and 1836
      \begin{itemize}
...
\begin{frame}
  \frametitle{A brief history of glacier flow}
  \begin{columns}
    \column[C]{4.25cm}
...
\begin{frame}
  \frametitle{A brief history of glacier flow}
    \includegraphics[width=12cm]{philosophy}
\end{frame}
