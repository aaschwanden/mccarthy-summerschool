...
\begin{frame}{From Navier Stokes to Stokes}
  ...
  \end{equation}
  %% \begin{equation}
  %%   \rho \underbrace{\frac{\textrm{d} {\bm{v}}}{\textrm{d} t}}_{acceleration} =  \underbrace{-\frac{1}{\textrm{Re}}\nabla p}_{pressure} +  \underbrace{\frac{1}{\textrm{Re}}\nabla \cdot \bm{\tau}}_{viscous}  + \underbrace{\frac{1}{Fr}\rho\bm{g}}_{gravity} + \underbrace{\frac{1}{Ro}\rho\bm{f}}_{Coriolis}
  %% \end{equation}
  \end{block}
