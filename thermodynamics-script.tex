...
tensor, respecitively..  Because usually the shearing deformation
...
\midrule % Density of ice & $\rho_i$ & $\sim 917$ &
...
% The melting temperature temperature can vary quite rapidly due to
changing water % pressure.  An example from a borehole in
...
% The pressure dependence of melting temperature temperature is
important for thick % ice masses: under the Antarctica
...
\begin{figure}
  \centering{
    \input{figures/phase-change.tikz}
  }
