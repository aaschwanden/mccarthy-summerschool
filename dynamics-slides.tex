...
\begin{frame}{Flow of a Glacier in a Semi-Circular Valley}
  ...
  \begin{block}{Assumptions}
    ...
    \item body force has to be balanced by tractions acting on the circumerence in distance $r$ from the center
      \begin{equation*}
...
\item center line velocity is \alert{eight} times slower than in an ice sheet of the same thickness
\end{itemize}
\end{block}
\end{frame}
