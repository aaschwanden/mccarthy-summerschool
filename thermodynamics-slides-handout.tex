...
\begin{columns}[c]
    ...
    \begin{column}{.7\linewidth}
      ...
      \begin{figure}
        ...
        \includegraphics<1>[width=\textwidth]{figures/ant_bmelt_temp}
        \includegraphics<2>[width=\textwidth]{figures/ant_bmelt_enth} \\
        {\small M. Martin, PIK}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{columns}[c]
    ...
    \begin{column}{.7\linewidth}
      ...
      \begin{figure}
        ...
        \only<2>{\small{\alert{enthalpy equation}} \\}
        {\footnotesize basal melt rate, meters per year}\\
        \includegraphics<1>[width=.55\textwidth]{figures/grn_bmelt_temp}
        \includegraphics<2>[width=.55\textwidth]{figures/grn_bmelt_enth} \\
     \end{figure}
    \end{column}
  \end{columns}
\end{frame}
