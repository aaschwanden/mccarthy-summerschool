...
\setbeamertemplate{background canvas}
  {
     \tikz{\node[inner sep=0pt,opacity=0.70] {\includegraphics[height=
...
\begin{frame}{The role of liquid water}
  \begin{columns}
    \column[C]{8cm}
    \begin{transbox}
      at all three interfaces: lateral, basal, surface
      \begin{itemize}
      \item acts as a lubricant at the base (e.g. surging glaciers)
      \item attacks ice shelfs from below (sub-shelf basal melting)
      \item drives calving and frontal ablation of lake and ocean terminating glaciers
      \item liquid water within the ice matrix softens the ice
      \end{itemize}
    \end{transbox}
  \end{columns}
\end{frame}
    ...
    \begin{transbox}
      \begin{block}{at the lateral margin}
        \begin{columns}
          \column[C]{2cm}
          \begin{figure}
            \includegraphics[height=2.5cm]{figures/calving-close-up}
          \end{figure}
          \column[C]{7cm}
