...
\begin{frame}
  ...
  \begin{block}{Rule of thumb}
    \begin{itemize}
    \item whenever something interesting happens in/on a glacier, liquid water is involved
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{The role of liquid water}
  \begin{columns}
    ...
    \begin{transbox}
      \begin{block}{Rule of thumb}
        whenever something interesting happens in/on a glacier, liquid water is involved
      \end{block}
    \end{transbox}
  \end{columns}
\end{frame}
