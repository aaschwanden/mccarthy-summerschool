...
\begin{frame}
  ...
  \end{itemize}
  \begin{figure}
    \includegraphics[scale=1.25]{greveblatter_disg}
  \end{figure}
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{transbox}
      ...
      \begin{columns}
        ...
        \column[c]{5.8cm}
        \begin{itemize}
        \item how does a temperature in the first 15\,look like?
        \end{itemize}
      \end{columns}
    \end{transbox}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    \column[C]{10cm}
    \begin{transbox}
      \begin{block}{Observation vs analytical solution}
        \begin{figure}
          \includegraphics[width=4.85cm]{temp-variation}
          \includegraphics[width=4.85cm]{colle-analytical}
        \end{figure}
      \end{block}
    \end{transbox}
  \end{columns}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=5cm]{forno}
  \end{figure}
...
\begin{frame}
 ...
 \end{figure}
  ...
  \item Alaska (e.g. McCall Glacier, see exercise)
