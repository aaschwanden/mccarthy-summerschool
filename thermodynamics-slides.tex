  ...
  \begin{columns}
    ...
    \begin{transbox}
      \begin{itemize}
        ...
        \item mean annual air temperature of $\sim$-14\,\celsius
      \end{itemize}
      \begin{figure}
...
%     \vspace{-1em}
%     \begin{figure}
%       \movie[width=7.cm,showcontrols=true]{\includegraphics[width=7.cm]{temp-variation}}{heat-flow-sinus-forcing.avi}
