...
\begin{block}{Noteworthy}
\begin{equation*}
v_{x, \mathrm{channel}} = \left(\frac{1}{2}\right)^{n} v_{x, \mathrm{slab}}
\end{equation*}
\begin{itemize}
...
\begin{frame}
  ...
  \begin{equation*}
    \frac{\partial h}{\partial t} = \underbrace{-\nabla \cdot \mathbf{Q}}_{\mathrm{dynamic changes}} \quad \underbrace{+B_{\mathrm{clim}}}_{\mathrm{climatic changes}}
  \end{equation*}
\end{frame}
